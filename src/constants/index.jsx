export const features = [
  {
    ...
    caption: 'Simple setup',
    title: 'Work with clarity, not confusion',
    text: "With SurePay, “Did you pay?” and “When do I get paid?” becomes history. One shared timeline keeps both sides aligned — create steps, submit work, approve, and pay.",
    button: {
  ...
  },
  {
    ...
    caption: 'Clear & verifiable',
    title: 'Sleep easy, everyone stays protected',
    text: 'Funds are locked until a milestone is approved. Every payment has a receipt link you can verify on Solana, so both sides can trust the process without back-and-forth.',
    button: {
      icon: '/images/docs.svg',
      title: 'See how proof works',
    },
  },
];
...
export const details = [
  {
    ...
    title: 'Milestone plans made simple',
  },
  {
    id: '1',
    icon: '/images/detail-2.png',
    title: 'Submit work with links & notes',
  },
  {
    id: '2',
    icon: '/images/detail-3.png',
    title: 'Instant approval → payment release',
  },
  {
    id: '3',
    icon: '/images/detail-4.png',
    title: 'Built for clients + freelancers',
  },
];
...
export const faq = [
  {
    id: '0',
    question: 'How fast can I set up a project?',
    answer:
      'Setting up a project is designed to be quick and intuitive. You will be able to get started in minutes once we launch.',
  },
  {
    id: '1',
    question: 'Do both sides need crypto experience?',
    answer:
      'No, we aim to make the process as seamless as possible, regardless of your experience level with crypto.',
  },
  {
    id: '2',
    question: 'What exactly is a “milestone”?',
    answer:
      'A milestone is a specific step or deliverable in your project. You set clear goals, and funds are released when those goals are met.',
  },
  {
    id: '3',
    question: 'What’s your refund policy for reservations?',
    answer:
      'If we don’t build it, you’re refunded. Your reservation ensures you are first in line for early access.',
  },
  {
    id: '4',
    question: 'What happens if you don’t build it?',
    answer:
      'As mentioned in our refund policy, any reservation deposits will be returned if the platform does not launch.',
  },
  {
    id: '5',
    question: 'How do approvals and payments work?',
    answer:
      'Funds are locked upfront. When work is submitted and approved by the client, the payment is instantly released to the freelancer.',
  },
  {
    id: '6',
    question: 'Can I change milestones after starting?',
    answer:
      'We are building flexibility into the system to allow for adjustments as projects evolve.',
  },
  {
    id: '7',
    question: 'How do I invite a client or freelancer?',
    answer:
      'You will be able to easily invite them via email or a direct link to your project workspace.',
  },
  {
    id: '8',
    question: 'How do disputes work (without drama)?',
    answer:
      'We focus on clear, verifiable proof and shared timelines to minimize disputes. Formal dispute resolution mechanisms will be available.',
  },
  {
    id: '9',
    question: 'What fees will you charge at launch?',
    answer:
      'We are finalizing our fee structure to be competitive and fair. Stay tuned for official announcements.',
  },
];
...
export const plans = [
  {
    ...
    priceMonthly: 12,
    priceYearly: 12,
    caption: 'Best for solo freelancers',
    features: [
      '1 active project at a time',
      'Milestone timeline + statuses',
      'Proof receipts for payments',
      'Email support',
    ],
  ...
  },
  {
    ...
    priceMonthly: 59,
    priceYearly: 59,
    caption: 'Most popular for clients',
    features: [
      'Everything in Core',
      'Unlimited projects',
      'Team roles (client + freelancer)',
      'Priority onboarding',
    ],
  ...
  },
  {
    ...
    priceMonthly: 29,
    priceYearly: 29,
    caption: 'Best for small teams & agencies',
    features: [
      'Everything in Overdrive',
      'Multi-client workspace',
      'Shared review + approvals',
...
export const testimonials = [
  {
    ...
    comment:
      "Finally, a clean way to pay by steps. No awkward follow-ups, just a clear timeline.",
  },
  {
    id: '1',
    name: 'Mark Erixon',
    ...
    comment:
      "I can show my client the proof link and move on. That’s the best part.",
  },
  {
    id: '2',
    name: 'Melanie Hurst',
    ...
    comment:
      "Setup was straightforward. The whole process feels calmer and more professional.",
  },
  {
    id: '3',
    name: 'Alicia Barker',
    ...
    comment:
      "The shared statuses removed so much confusion from our projects.",
  },
  {
    id: '4',
    name: 'Becky Snider',
    ...
    comment:
      "We reserved early because this solves the one problem every freelance project has.",
  },
  {
    id: '5',
    name: 'Jim Bradley',
    ...
    comment:
      "Clear steps, clear approvals, clear payments. That’s the workflow we wanted.",
  },
];
...
export const logos = [
  ...
  },
  {
    id: '5',
    title: 'Jupiter',
    url: '/images/logos/drips.svg', // Reusing placeholder
    width: 77,
    height: 48,
  },
];
